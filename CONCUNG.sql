...
(
  NAME = 'GiatienF1',
  FILENAME = 'C:\Users\Admin\Desktop\DATA\GiatienF1.ndf'
) TO FILEGROUP FG1
GO
...
(
  NAME = 'GiatienF2',
  FILENAME = 'C:\Users\Admin\Desktop\DATA\GiatienF2.ndf'
) TO FILEGROUP FG2
GO
...
(
  NAME = 'GiatienF3',
  FILENAME = 'C:\Users\Admin\Desktop\DATA\GiatienF3.ndf'
) TO FILEGROUP FG3
GO
...
(
	...
	TONGTIEN FLOAT,
	THANH_TIEN FLOAT,
	CONSTRAINT PK_GH PRIMARY KEY(MA_GIO)
)
GO
...
(
	...
	SOLUONG INT,
	THANH_GIA FLOAT,
	CONSTRAINT PK_GH PRIMARY KEY(MA_GIO,MA_SP)
)

ALTER TABLE GIOHANG
ADD CONSTRAINT FK_GH_BM
FOREIGN KEY(SDT)
REFERENCES BOME
GO

ALTER TABLE GIOHANG
ADD CONSTRAINT FK_GH_PGG
...
ALTER TABLE GIOHANG
ADD CONSTRAINT DF_THANHGIA
DEFAULT 0 FOR THANHGIA
