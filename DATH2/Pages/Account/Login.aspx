...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p class="auto-style5">
        &nbsp;&nbsp;&nbsp;&nbsp;
        Số điện thoại:<asp:TextBox ID="txtPhoneNum" runat="server" CssClass="auto-style4"></asp:TextBox>
    </p>
    <p class="auto-style3">
        Mật khẩu:<asp:TextBox ID="txtPass" runat="server" CssClass="auto-style4" Height="16px" TextMode="Password"></asp:TextBox>
    </p>
    <p>
